...
- [electron-boilerplate](https://github.com/kewde/electron-sandbox) *(by kewde)* - Boilerplate (and tutorial) for creating an electron application with a focus on security (sandbox & communication over IPC).
